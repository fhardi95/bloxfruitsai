  ...
  return (
    <section id="tier-list" style={{ position:"relative", zIndex:1, padding:"6rem 5%", background:"linear-gradient(180deg,transparent,rgba(0,245,255,0.02),transparent)" }}>
      <div style={{ textAlign:"center", marginBottom:"3.5rem" }}>
        <span style={{ display:"inline-block", fontSize:"0.7rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"var(--cyan)", background:"rgba(0,245,255,0.08)", border:"1px solid rgba(0,245,255,0.2)", padding:"4px 14px", borderRadius:50, marginBottom:"1rem" }}>Updated 2026</span>
