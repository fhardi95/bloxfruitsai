...
const STATS = [
  { target: 45, suffix: "+", label: "Fruits Tracked" },
  { target: 46, suffix: "+", label: "Wiki Guides" },
  { target: 0, suffix: "", label: "Login Required", text: "No" },
  { target: 0, suffix: "", label: "Cost", text: "Free" },
];
          ...
          {STATS.map((s, i) => (
            <div key={s.label} style={{ textAlign: "center" }}>
              <span style={{ fontFamily: "'Orbitron',monospace", fontSize: "2rem", fontWeight: 700, color: "var(--cyan)", display: "block" }}>
                {s.text ? s.text : Math.floor(counts[i]) + s.suffix}
              </span>
