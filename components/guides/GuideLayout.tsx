...
export default function GuideLayout({ tag, title, titleHighlight, description, breadcrumb, children, readTime = "8 min read", updatedDate = "July 2026" }: GuideLayoutProps) {
  return (
