        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "2rem" }}>
            <div style={{ maxWidth: 620 }}>
              <span style={{ display: "inline-block", fontSize: "0.7rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#00f5ff", background: "rgba(0,245,255,0.08)", border: "1px solid rgba(0,245,255,0.2)", padding: "4px 14px", borderRadius: 50, marginBottom: "1rem" }}>Mis à jour 2026</span>
            ...
            <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
              {[{ num: "5", label: "Guides" }, { num: "Gratuit", label: "Sans compte" }, { num: "2026", label: "Mis à jour" }].map(s => (
