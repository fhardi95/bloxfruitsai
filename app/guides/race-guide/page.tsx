...
export const metadata: Metadata = {
  title: "Blox Fruits Race Guide 2025 — Best Race Tier List & Awakenings",
  description: "Complete Blox Fruits race guide for 2025. Best race tier list, V4 awakening requirements, and which race pairs best with every devil fruit build.",
...
export default function RaceGuidePage() {
  return (
    ...
    >
      <GuideSection title="Race Tier List 2025" icon="🏆" accent="gold">
