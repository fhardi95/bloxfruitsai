...
export const metadata: Metadata = {
  title: "Blox Fruits Beginner Guide 2025 — Start Here",
  description: "New to Blox Fruits? This complete beginner guide covers everything — first fruit, stats, Haki, Sea progression, and how to reach max level efficiently in 2025.",
...
export default function BeginnerGuidePage() {
  return (
    <GuideLayout
      ...
      description="Never played Blox Fruits before? This guide covers everything you need to know — from your very first fruit to reaching max level. Written for complete newcomers in 2025."
