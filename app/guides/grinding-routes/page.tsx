...
export const metadata: Metadata = {
  title: "Best Grinding Routes 2025 — Fastest XP & Beli Farming Guide",
  description: "Fastest Blox Fruits grinding routes for every level range in 2025. Maximize XP per hour, Beli farming, and boss drop rates with our AI-optimized route guide.",
