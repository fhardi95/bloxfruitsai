...
export const FRUITS: Fruit[] = [
  ...
  { id: 't-rex', name: 'T-Rex', emoji: '🦖', tier: 'S', type: 'Beast', category: 'Fruit', value: 6200000, permanentValue: 2350, demand: 9, price: 2350, rarity: 'Mythical', trend: 'up', pvp: 9, pve: 8, description: 'Transforms into a Tyrannosaurus Rex with brutal ground combos and a tracking bleed effect. Dominant in close-range PVP.' },
  { id: 'mammoth', name: 'Mammoth', emoji: '🐘', tier: 'S', type: 'Beast', category: 'Fruit', value: 5400000, permanentValue: 2350, demand: 8, price: 2350, rarity: 'Mythical', trend: 'stable', pvp: 8, pve: 9, description: 'Armored mammoth transformation with huge AoE and knockback. Excellent for grinding and large-scale fights.' },
  // A TIER
  ...
  { id: 'spirit', name: 'Spirit', emoji: '👻', tier: 'A', type: 'Natural', category: 'Fruit', value: 2300000, permanentValue: 2550, demand: 7, price: 2550, rarity: 'Mythical', trend: 'stable', pvp: 7, pve: 8, description: 'Summons spirits to attack, heal, or boost speed. Versatile support-style fruit with strong AoE.' },
  { id: 'control', name: 'Control', emoji: '🌀', tier: 'A', type: 'Natural', category: 'Fruit', value: 2100000, permanentValue: 2500, demand: 7, price: 2500, rarity: 'Mythical', trend: 'stable', pvp: 8, pve: 6, description: 'Creates a zone where the user manipulates objects and gains high mobility. Strong utility fruit in skilled hands.' },
  { id: 'portal', name: 'Portal', emoji: '🌌', tier: 'A', type: 'Natural', category: 'Fruit', value: 1900000, permanentValue: 1899, demand: 8, price: 1899, rarity: 'Legendary', trend: 'up', pvp: 9, pve: 6, description: 'Instant teleportation and zoning. The best mobility fruit in the game for dictating fights on your terms.' },
  { id: 'rumble', name: 'Rumble', emoji: '⚡', tier: 'A', type: 'Elemental', category: 'Fruit', value: 1700000, permanentValue: 2100, demand: 7, price: 2100, rarity: 'Legendary', trend: 'stable', pvp: 8, pve: 8, description: 'Thunder God transformation grants flight and devastating AoE lightning attacks. A consistently demanded all-rounder for PVP and grinding.' },
  // B TIER
  ...
  { id: 'light', name: 'Light', emoji: '💡', tier: 'B', type: 'Elemental', category: 'Fruit', value: 700000, permanentValue: 1100, demand: 6, price: 1100, rarity: 'Rare', trend: 'stable', pvp: 6, pve: 8, description: 'Fastest flight speed in the early game with strong AoE. One of the best First Sea grinding fruits.' },
  { id: 'paw', name: 'Paw', emoji: '🐾', tier: 'B', type: 'Natural', category: 'Fruit', value: 650000, permanentValue: 1100, demand: 5, price: 1100, rarity: 'Rare', trend: 'stable', pvp: 6, pve: 6, description: 'Compressed air pads deliver exceptional single-target burst at range. Underrated mid-game pick with reliable boss damage.' },
  // C TIER
  ...
  { id: 'sand', name: 'Sand', emoji: '🏜️', tier: 'C', type: 'Natural', category: 'Fruit', value: 240000, permanentValue: 850, demand: 4, price: 850, rarity: 'Uncommon', trend: 'stable', pvp: 5, pve: 4, description: 'Awakened form offers solid hitboxes and stun in PVP, but the unawakened kit is below average.' },
  { id: 'diamond', name: 'Diamond', emoji: '💎', tier: 'C', type: 'Natural', category: 'Fruit', value: 220000, permanentValue: 1000, demand: 4, price: 1000, rarity: 'Uncommon', trend: 'stable', pvp: 5, pve: 5, description: 'Defensive Logia-style fruit good for tanking hits while playing Sword, Gun, or Fighting Style builds.' },
  { id: 'flame', name: 'Flame', emoji: '🔥', tier: 'C', type: 'Elemental', category: 'Fruit', value: 190000, permanentValue: 379, demand: 3, price: 379, rarity: 'Uncommon', trend: 'stable', pvp: 4, pve: 5, description: 'Easy to use early-game Elemental fruit with solid AoE damage. Outclassed once better fruits unlock.' },
  // D TIER
  ...
  { id: 'gp_2money', name: '2x Money', emoji: '💰', tier: 'A', type: 'Natural', category: 'Gamepass', value: 700000, permanentValue: 379, demand: 6, price: 379, rarity: 'Rare', trend: 'stable', pvp: 0, pve: 0, description: 'Doubles Beli earned from every source. A top pick for grinding toward fruits and gear faster.' },
  { id: 'gp_2bossdrop', name: '2x Boss Drops', emoji: '🎯', tier: 'A', type: 'Natural', category: 'Gamepass', value: 750000, permanentValue: 399, demand: 6, price: 399, rarity: 'Rare', trend: 'stable', pvp: 0, pve: 0, description: 'Doubles drop chances from boss raids. Essential for farming fragments and rare fruit drops efficiently.' },
  { id: 'gp_notifier', name: 'Fruit Notifier', emoji: '🔔', tier: 'B', type: 'Natural', category: 'Gamepass', value: 300000, permanentValue: 199, demand: 5, price: 199, rarity: 'Uncommon', trend: 'stable', pvp: 0, pve: 0, description: 'Alerts you the moment a Mythical or Legendary fruit spawns nearby. Saves hours of manual fruit hunting.' },
  // LIMITEDS
  { id: 'dark-blade', name: 'Dark Blade', emoji: '🗡️', tier: 'A', type: 'Natural', category: 'Limited', value: 1800000, permanentValue: 0, demand: 6, price: 0, rarity: 'Legendary', trend: 'stable', pvp: 7, pve: 5, description: 'Limited legacy sword obtained only through the 2024 Dragon Token exchange. No longer purchasable — high trade demand from collectors and PVP players alike.' },
  { id: 'perm-dragon-token', name: 'Permanent Dragon Token', emoji: '🎫', tier: 'S', type: 'Natural', category: 'Limited', value: 3000000, permanentValue: 0, demand: 6, price: 0, rarity: 'Mythical', trend: 'stable', pvp: 0, pve: 0, description: 'Legacy compensation item from the 2024 Dragon rework. Can be redeemed for a discounted Permanent Dragon Fruit or other rewards. No longer obtainable — among the rarest tradeable items in the game.' },
];
