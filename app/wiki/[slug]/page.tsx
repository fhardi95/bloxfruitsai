...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const metaTitle = `${fruit.name} Fruit Guide 2026 – Moves, Awakening & Best Combos`;
  ...
  const metaDesc = `Everything you need to know about ${fruit.name} fruit in Blox Fruits. Full moveset, awakening cost, best combos, and is it worth buying in 2026?.`;
