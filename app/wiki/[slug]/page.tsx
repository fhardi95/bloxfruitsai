...
// Per-fruit SEO overrides for high-traffic wiki pages
const WIKI_SEO_OVERRIDES: Record<string, { title: string; description: string }> = {
  kitsune: {
    title: "Kitsune Fruit Blox Fruits 2026 — Value, Moves, Best Builds & Is It Worth It?",
    description: "Kitsune is the highest BFV value fruit in Blox Fruits 2026 (2,499 Robux). Full guide: all 5 moves, Spirit Form ultimate, best PVP combos, top builds, and current trade value. Should you buy or trade for it?",
  },
  dragon: {
    title: "Dragon Fruit Blox Fruits 2026 — Value, Moves, Best Builds & Price",
    description: "Dragon fruit complete guide for Blox Fruits 2026. S-tier for PVP, PVE, and grinding — 2,499 Robux. See all moves, best combos, stat builds, and current BFV trade value.",
  },
  dough: {
    title: "Dough Fruit Blox Fruits 2026 — Value, Moves, Best Grinding Builds",
    description: "Dough fruit guide for Blox Fruits 2026. Best fruit for grinding in the current meta — see all moves, awakening cost, top builds, and current BFV trade value and demand score.",
  },
  venom: {
    title: "Venom Fruit Blox Fruits 2026 — Value, Moves & Best Builds",
    description: "Venom is now S-tier in Blox Fruits 2026 after the May buff (+15% PVP damage). Venom Demon form, best builds, BFV trade value & if it's worth 1,799 Robux.",
  },
  shadow: {
    title: "Shadow Fruit Blox Fruits 2026 — Moves, Umbra Mode & Trade Value",
    description: "Shadow fruit full guide for Blox Fruits 2026. All moves, Umbra awakening cost, current BFV trade value, best builds for PVP and whether it's worth buying.",
  },
  blizzard: {
    title: "Blizzard Fruit Blox Fruits 2026 — Moves, Value & Best Builds",
    description: "Blizzard fruit guide for Blox Fruits 2026. Best elemental fruit for PVP and grinding — all moves, freeze combos, awakening cost and current trade value.",
  },
  buddha: {
    title: "Buddha Fruit Blox Fruits 2026 — Best Grinding Fruit Guide",
    description: "Buddha is the #1 grinding fruit in Blox Fruits 2026. Full guide — all moves, awakening cost, best race, damage reduction stats, and current BFV trade value.",
  },
  rumble: {
    title: "Rumble Fruit Blox Fruits 2026 — Moves, Value & PVP Guide",
    description: "Rumble fruit full guide for Blox Fruits 2026. All moves, awakening requirements, current BFV trade value and whether Rumble is still worth using in the current meta.",
  },
  leopard: {
    title: "Leopard Fruit Blox Fruits 2026 — Moves, Value & PVP Combos",
    description: "Leopard fruit complete guide for Blox Fruits 2026. The fastest fruit in the game — all moves, best PVP combos, awakening cost, BFV trade value and top builds.",
  },
  phoenix: {
    title: "Phoenix Fruit Blox Fruits 2026 — Healing, Moves & Trade Value",
    description: "Phoenix fruit guide for Blox Fruits 2026. Best sustain fruit for PVE and boss raids — all moves, passive regen stats, awakening cost and current BFV trade value.",
  },
  magma: {
    title: "Magma Fruit Blox Fruits 2026 — Best Grinding Moves & Value",
    description: "Magma fruit full guide for Blox Fruits 2026. Top grinding fruit after Buddha — all moves, magma floor mechanic, awakening cost, and current BFV trade value.",
  },
  ice: {
    title: "Ice Fruit Blox Fruits 2026 — Moves, Freeze Combos & Value",
    description: "Ice fruit guide for Blox Fruits 2026. Great beginner and mid-game fruit — all moves, freeze combo tips, PVP changes after the 2026 nerf and current trade value.",
  },
};
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const override = WIKI_SEO_OVERRIDES[slug];

  // Title: max ~60 chars to stay under 580px (Google truncation limit)
  const metaTitle = override?.title ?? `${fruit.name} Fruit Guide 2026 – Moves, Awakening & Best Combos`;

  // Description: max ~155 chars to stay under 1000px (Google truncation limit)
  const metaDesc = override?.description ?? `Everything you need to know about ${fruit.name} fruit in Blox Fruits. Full moveset, awakening cost, best combos, and is it worth buying in 2026?.`;
...
export default async function WikiFruitPage({ params }: Props) {
  ...
  const faqLd = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: `What moves does ${fruit.name} have in Blox Fruits?`,
        acceptedAnswer: {
          "@type": "Answer",
          text: `${fruit.name} has ${fruit.moves.length} moves in Blox Fruits 2026: ${fruit.moves.map(m => `${m.key} (${m.name}) — ${m.notes}`).join("; ")}.`,
        },
      },
      {
        "@type": "Question",
        name: `How do I check if a ${fruit.name} trade is fair?`,
        acceptedAnswer: {
          "@type": "Answer",
          text: `Use the BloxFruitsAI trade calculator at bloxfruitsai.com/calculator to check any ${fruit.name} trade instantly. Add ${fruit.name} to one side, add the offered fruit to the other, and the BFV calculator will tell you whether the trade is a W, L, or fair.`,
        },
      },
    ],
  };
