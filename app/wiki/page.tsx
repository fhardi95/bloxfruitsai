...
export const metadata: Metadata = {
  ...
  description:
    "Complete Blox Fruits wiki with every devil fruit, all moves, tier ratings, PVP and PVE scores, trade calculator values, and best builds. Updated after every patch.",
