...
const POSTS = [
  ...
  {
    slug: "kitsune-fruit-guide-2026",
    title: "Kitsune Guide: Moves, Awakening & Tips",
    excerpt: "Master the mythical Kitsune fruit with our complete 2026 guide covering all moves, awakening mechanics, PvP combos, and advanced transformation strategies.",
    date: "June 2026",
  ...
  {
    slug: "how-to-awaken-fruits-complete-guide-2026",
    title: "How to Awaken Fruits: Complete Guide 2026",
    excerpt: "Master fruit awakening in Blox Fruits with our comprehensive 2026 guide. Learn raid requirements, best fruits to awaken, and optimization strategies.",
    date: "June 2026",
    category: "Awakening Guides",
    categoryColor: "#9b59b6",
    categoryBg: "rgba(155,89,182,0.08)",
    categoryBorder: "rgba(155,89,182,0.25)",
    readTime: "12 min",
    icon: "⚡",
    featured: true,
  },
  ...
  },
  {
    ...
    title: "All Working Codes June 2026 — Free XP & Beli",
    excerpt: "Active codes for June 2026 giving free XP, Beli, and stat resets. Updated daily with new releases and verified working codes for max rewards.",
    date: "15 June 2026",
    category: "Codes & Rewards",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
    categoryBorder: "rgba(0,245,255,0.25)",
    readTime: "8 min",
  ...
  {
    slug: "blox-fruits-trading-guide-2026",
    title: "Trading Guide: Get Rare Fruits Fast 2026",
    excerpt: "Master trading tactics to acquire legendary fruits quickly. Learn value ratios, scam prevention, and server-hopping strategies that work in June 2026.",
    date: "15 June 2026",
    category: "Trading",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  {
    slug: "best-fruit-blox-fruits-2026",
    title: "Best Fruit Guide 2026 — Top Picks",
    excerpt: "Discover the absolute best fruit in Blox Fruits for June 2026. Complete tier list, PvP rankings, grinding strategies, and awakening priorities revealed.",
    date: "June 2026",
    category: "Tier Lists",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  {
    slug: "dragon-fruit-guide-moves-combos-2026",
    title: "Dragon Fruit Guide: Moves & Combos 2026",
    excerpt: "Master Dragon fruit in Blox Fruits with our complete 2026 guide covering all moves, best combos, awakening tips, and PvP strategies for dominance.",
    date: "June 2026",
    category: "Fruit Guides",
    categoryColor: "#ff4757",
    categoryBg: "rgba(255,71,87,0.08)",
  ...
  {
    slug: "race-tier-list-2026-best-ranked",
    title: "Race Tier List 2026: Best Ranked",
    excerpt: "Complete race tier list for June 2026. Discover which race dominates PvP, grinding, and raids with V4 abilities ranked from S to D tier.",
    date: "15 June 2026",
    category: "Tier Lists",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  },
  {
    ...
    excerpt: "Complete 2026 tier list ranking every Blox Fruits accessory by power. Discover where to find each item, PvP rankings, and optimal loadout combinations.",
    date: "June 2026",
    category: "Tier Lists",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  {
    slug: "all-working-codes-free-xp-beli-2026",
    title: "All Working Codes — Free XP & Beli 2026",
    excerpt: "Redeem every active code for free XP, Beli, and stat resets. Updated June 2026 with instant rewards—never miss double XP boosts again.",
    date: "June 2026",
    category: "Codes & Rewards",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  {
    slug: "blox-fruits-all-bosses-guide-2026",
    title: "All Bosses Guide: Locations & Drops 2026",
    excerpt: "Complete boss guide for Blox Fruits 2026 — every location, spawn time, drop rate, and strategy. Master all bosses from Gorilla King to Cake Queen.",
    date: "May 2026",
  ...
  },
  {
    ...
    title: "All Bosses Guide: Locations & Drops 2026",
    excerpt: "Complete boss guide covering every location, spawn time, drop rate and strategy. Updated May 2026 with new raid bosses and exclusive rewards.",
    date: "May 2026",
    category: "Boss Guides",
    categoryColor: "#ff4757",
    categoryBg: "rgba(255,71,87,0.08)",
  ...
  {
    slug: "trading-guide-rare-fruits-fast-2026",
    title: "Trading Guide: Get Rare Fruits Fast 2026",
    excerpt: "Master Blox Fruits trading in 2026. Learn proven strategies to acquire legendary fruits quickly through smart trades, value awareness, and negotiation tactics.",
    date: "May 2026",
    category: "Trading",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  },
  {
    ...
    title: "Best Race Tier List & Guide (May 2026)",
    excerpt: "Complete tier list of every race in Blox Fruits 2026. Discover which race dominates PvP, grinding, and raids with stat breakdowns and awakening tips.",
    date: "May 2026",
    category: "Tier Lists",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  {
    slug: "kitsune-fruit-guide-moves-awakening-tips",
    title: "Kitsune Fruit Guide: Moves & Awakening",
    excerpt: "Master the mythical Kitsune fruit with our complete guide covering all moves, awakening abilities, combat strategies, and expert tips for dominance in 2026.",
    date: "May 2026",
    category: "Fruit Guides",
    categoryColor: "#00f5ff",
    categoryBg: "rgba(0,245,255,0.08)",
  ...
  {
    slug: "best-pvp-fruit-blox-fruits",
    title: "Best PVP Fruit in Blox Fruits — Full Tier List & Top Combos",
    excerpt: "Tiger, Kitsune, Dragon, and Dough lead the PVP meta in Blox Fruits Update 31. We rank every top-tier fruit by damage, mobility, combo potential.",
    date: "May 10, 2026",
  ...
  {
    slug: "blox-fruits-awakening-guide",
    title: "Blox Fruits Awakening Guide — How to Awaken Fruits",
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "2rem" }}>
              {[{ num: String(POSTS.length), label: "Articles" }, { num: "May 25, 2026", label: "Latest" }].map(s => (
