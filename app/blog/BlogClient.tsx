...
const POSTS = [
  ...
  {
    slug: "best-fruits-for-pvp-blox-fruits",
    title: "Best Fruits for PvP: Top Tier List",
    excerpt: "Discover the most powerful PvP fruits in Blox Fruits. Complete tier list with combos, awakened abilities, and pro strategies for dominating player battles.",
    date: "May 22, 2026",
    category: "PvP Guides",
